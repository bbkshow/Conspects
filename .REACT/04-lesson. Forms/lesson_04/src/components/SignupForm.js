...
// onChange in React === vanila input event
...
export default class SignupForm extends Component {
    ...
    handleSubscriptionCahnge = event => {
    ...
    render() {
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                {/* <label id="qwe">Name</label>
                <input htmlFor="qwe" type="text" value="" name="name" /> */}
                <label>
                    Email
                    <input
                        type="email"
                ...
                <div role="group">
                    <label>
                        ...
                        <input
                            ...
                            onChange={this.handleSubscriptionCahnge}
                        />
                    </label>
                    <label>
                        Basic
